'use client'
import { Avatar, Box, Button, Divider, Grid, TextField, Typography, Snackbar, Alert } from "@mui/material";
...
const AuthSignIn = (props: any) => {
    ...
    const [resMessage, setRestMessage] = useState<string>('')
    ...
    const handleSubmit = async () => {
        ...
        setRestMessage(res?.error as string)
        setOpenMessage(true)
        setTimeout(() => {
